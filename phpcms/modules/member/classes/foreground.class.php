...
class foreground {
	...
	final public function check_member() {
		...
		if(ROUTE_M =='member' && ROUTE_C =='index' && in_array(ROUTE_A, array('login', 'register', 'mini','send_newmail','login_new','register_new','login_status','ip_login_api'))) {
			if ($phpcms_auth && ROUTE_A != 'mini'&&!empty($username)) {
			...
			//判断是否存在auth cookie
			if (!empty($phpcms_auth)&&!empty($username)) {
