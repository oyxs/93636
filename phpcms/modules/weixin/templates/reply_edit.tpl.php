...
<form name="myform" id="myform" action="?m=weixin&c=reply&a=reply_edit" method="post">
<div class="pad-10">
<div class="col-tab">
...
<table width="100%" class="table_form ">
		<tr>
            <th>关键字：</th>
            <td><input type="text" name="info[keyword]" id="keyword" class="input-text" value="<?php echo $datas['keyword'];?>"></td>
        </tr>
        <tr>
            <th>回复文本：</th>
            <td><textarea  style="width:600px;height:200px" name="info[content]" id="content" class="input-text" ><?php echo $datas['content'];?></textarea></td>
        </tr>
        <tr>
            <th>图文标题：</th>
            <td><input type="text" name="info[title]" id="title" class="input-text" style="width:400px;" value="<?php echo $datas['title'];?>"></td>
        </tr>
        <tr>
        ...
        <tr>
            <th>回复链接：</th>
            <td><input type="text" name="info[url]" id="url" class="input-text" style="width:400px;" value="<?php echo $datas['url'];?>"></td>
        </tr>
        <tr>
            <th>类型：</th>
            <td><input type='radio' name='info[type]' value='1' <?php if($datas['type']==1) echo 'checked';?>> <?php echo '纯文本模式';?>&nbsp;&nbsp;&nbsp;&nbsp;
	  			<input type='radio' name='info[type]' value='2' <?php if($datas['type']==2) echo 'checked';?>> <?php echo '图片模式';?>&nbsp;&nbsp;&nbsp;&nbsp;
	  			<input type='radio' name='info[type]' value='3' <?php if($datas['type']==3) echo 'checked';?>> <?php echo '图文模式';?></td>
        </tr>
