...
// 签名证书路径
const SDK_SIGN_CERT_PATH = '../../static/certs/04zhengshu.pfx';

// 签名证书密码
const SDK_SIGN_CERT_PWD = '111111';

// 密码加密证书（这条一般用不到的请随便配）
const SDK_ENCRYPT_CERT_PATH = '../../static/certs/acp_test_enc.cer';

// 验签证书路径（请配到文件夹，不要配到具体文件）
const SDK_VERIFY_CERT_DIR = '../../static/certs/';
...
// 前台通知地址 (商户自行配置通知地址)
const SDK_FRONT_NOTIFY_URL = 'http://www.93636.com/UnionPay/demo/api_01_gateway/FrontReceive.php';

// 后台通知地址 (商户自行配置通知地址，需配置外网能访问的地址)
const SDK_BACK_NOTIFY_URL = 'http://www.93636.com/UnionPay/demo/api_01_gateway/BackReceive.php';
