...
cityareacode[32]=new Array('3301','3302','3303','3304','3305','3306','3307','3308','3309','3310','3311','3312','3313','3314','3315','3316','3317','3318');
cityareaname[32]=new Array('中西区','东区','九龙城区','观塘区','南区','深水区','湾仔区','黄大仙区','油尖旺区','离岛区','葵青区','北区','西贡区','沙田区','屯门区','大浦区','荃湾区','元朗区');
if (selectP=='34')
{ a=34;tempoption=new Option('澳门','34',false,true); }
else
{ tempoption=new Option('澳门','34'); }
eval('document.'+VeryHuo+'.'+preP+'.options[34]=tempoption;');
cityareacode[33]=new Array('3401','3402','3403','3404','3405','3406','3407');
cityareaname[33]=new Array('花地玛堂区','圣安多尼堂区','大堂区','望德堂区','风顺堂区','嘉模堂区','圣方济各堂区');
if (selectP=='35')
{ a=35;tempoption=new Option('台湾','35',false,true); }
else
{ tempoption=new Option('台湾','35'); }
eval('document.'+VeryHuo+'.'+preP+'.options[35]=tempoption;');
cityareacode[34]=new Array('3501','3502','3503','3504','3505','3506','3507','3508','3509','3510','3511','3512','3513','3514','3515','3516','3517','3518','3519','3520','3521','3522','3523');
